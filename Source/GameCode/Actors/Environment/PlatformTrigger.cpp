...
void APlatformTrigger::Multicast_SetActivated_Implementation(bool bIsActivated_In)
{
...
void APlatformTrigger::OnTriggerOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex,
